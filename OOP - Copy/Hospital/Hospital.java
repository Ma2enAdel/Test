...
public class Hospital {
    ...
    public void setNumOfRooms(int NumOfRooms) {
        //Checks that Number of rooms isn't in negative
        if(NumOfRooms<=0){
    ...
    public void setNumOfDoctors(int NumOfDoctors) {
        //Checks that number of doctors isn't in negative
        if(NumOfDoctors<0){
            System.out.println("Error, Invalid Number of Doctors");
        }
        else{
            this.NumOfDoctors = NumOfDoctors;
    }
    ...
    public void setNumOfNurses(int NumOfNurses) {
        //Checks that number of nurses isn't in negative
        if(NumOfNurses<0){
            System.out.println("Error, Invalid Number of Nurses");
        }
        else{
            this.NumOfNurses = NumOfNurses;}
    }
    ...
    public void setNumOfPatients(int NumOfPatients) {
        //Checks that number of patients isn't in negative
        if(NumOfPatients<0){
            System.out.println("Error, Invalid Number of Patients");
        }
        else{
            this.NumOfPatients = NumOfPatients;
    }
    ...
    public void printDetails(){
        System.out.println("Hospital information\nHospital Name:"+Name+"\nHospital Address:"+Address+"\nPhone Number"+PhoneNumber+"\nNumber of Doctors"+NumOfDoctors+"\nNumber of Nurses"+NumOfNurses+"\nNumber of Patients"+NumOfPatients+"\nNumber of Rooms"+NumOfRooms);
    }
